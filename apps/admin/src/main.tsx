...
function App() {
  ...
  const [packageForm, setPackageForm] = useState<PackageForm>({ projectId: 'neverlauncher-project', profileId: 'vanilla-java21', channel: 'stable', version: '0.10.3-client', packageId: '', path: 'mods/example.jar', sha256: '' });
  ...
  return <main className="layout">
    ...
    <section className="main">
      <header className="header">
        <div><h1>NeverLauncher Admin · API v1</h1><p>Рабочая панель NeverLauncher 0.10.3: проекты, профили, каналы, пользователи, подписанный релизный поток, multipart-загрузка, ServerBridge, диагностика и резервное копирование через единый /api/v1.</p></div>
