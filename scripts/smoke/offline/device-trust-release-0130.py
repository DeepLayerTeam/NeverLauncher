...
except ValueError: raise SystemExit(f'invalid VERSION: {version}')
if len(version_tuple)!=3 or version_tuple < (0,13,0): raise SystemExit(f'Device Trust Release gate requires >=0.13.0, got {version}')
...
print(f'[NeverLauncher] Device Trust Release gate OK: {version}')
