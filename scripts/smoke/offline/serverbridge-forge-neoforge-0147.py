...
require(forge_build,['net.minecraftforge.gradle','1.21.1-52.1.16','bridgeRuntime(project(":plugins:modloader-family-common"))'],"Forge production build")
require(neo_build,['net.neoforged.moddev','21.1.251','bridgeRuntime(project(":plugins:modloader-family-common"))'],"NeoForge production build")
