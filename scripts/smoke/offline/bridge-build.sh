...
for platform in velocity bungeecord waterfall bukkit spigot paper purpur folia; do
...
for field in velocitySha256 bungeeCordSha256 waterfallSha256 bukkitSha256 spigotSha256 paperSha256 purpurSha256 foliaSha256; do
