...
spec={
 "openapi":"3.1.1",
 "info":{"title":"NeverLauncher API","version":"1.0.0","description":"Канонический production API NeverLauncher 0.10.7. Исторические маршруты /api/v2–/api/v5 удалены и намеренно не входят в контракт."},
