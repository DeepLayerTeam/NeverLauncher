...
"ServerRegisterRequest":{"type":"object","required":["id","kind","projectId","keyAlgorithm","publicKey"],"properties":{"id":{"type":"string","minLength":1},"name":{"type":"string"},"kind":{"type":"string","enum":["velocity","bukkit","spigot","paper","purpur","folia"]},"projectId":{"type":"string","minLength":1},"profileId":{"type":"string"},"fingerprint":{"type":"string"},"keyAlgorithm":{"type":"string","const":"ed25519"},"publicKey":{"type":"string","pattern":"^[A-Za-z0-9_-]{43}$","description":"Raw 32-byte Ed25519 public key encoded as unpadded base64url. The private key never leaves the ServerBridge node."}},"additionalProperties":False},
...
"HeartbeatRequest":{"type":"object","required":["protocolVersion","serverId","serverType","pluginVersion","pluginSha256"],"properties":{"protocolVersion":{"type":"integer","const":2},"serverId":{"type":"string"},"serverType":{"type":"string","enum":["velocity","bukkit","spigot","paper","purpur","folia"]},"pluginVersion":{"type":"string"},"pluginSha256":{"type":"string","pattern":"^[0-9a-fA-F]{64}$","description":"SHA-256 of the running ServerBridge JAR"}},"additionalProperties":False},
