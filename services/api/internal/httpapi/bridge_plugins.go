...
func bridgePluginsStatus940(version string) map[string]any {
	return map[string]any{
		"schemaVersion":   bridgePluginsSchema940,
		"toolVersion":     version,
		"release":         "NeverLauncher 0.14.5 Proxy family",
...
func bridgePluginsManifest940(version string) map[string]any {
	return map[string]any{
		...
		"configExamples":   []string{"plugins/velocity-bridge/config.example.yml", "plugins/bungeecord-bridge/config.example.yml", "plugins/waterfall-bridge/config.example.yml", "plugins/bukkit-bridge/config.example.yml", "plugins/spigot-bridge/config.example.yml", "plugins/paper-bridge/config.example.yml", "plugins/purpur-bridge/config.example.yml", "plugins/folia-bridge/config.example.yml"},
