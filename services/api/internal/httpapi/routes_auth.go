...
func (s Server) registerAuthRoutesV1(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/v1/auth/devices", s.authDevices0121)
	...
	mux.HandleFunc("DELETE /api/v1/auth/devices/{deviceId}", s.authDeviceRevoke0121)
	mux.Handle("GET /api/v1/admin/auth/sessions", s.requirePermission("users:manage", s.adminAuthSessions118))
	mux.Handle("GET /api/v1/admin/auth/devices", s.requirePermission("users:manage", s.adminAuthDevices0121))
	mux.Handle("DELETE /api/v1/admin/auth/devices/{deviceId}", s.requireFreshAuth117("users:manage", "phishing-resistant", 5*time.Minute, s.adminAuthDeviceRevoke0121))
