...
func TestCanonicalBridgePluginFlow(t *testing.T) {
	...
	req = httptest.NewRequest(http.MethodPost, "/api/v1/server-bridge/servers/velocity-940/heartbeat", strings.NewReader(`{"serverType":"velocity","pluginVersion":"0.10.5"}`))
